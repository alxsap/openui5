sap.ui.require(["sap/ui/core/Core"], Core => Core.ready(function () {
	...
	], function(App, Button, CheckBox, DatePicker, Input, Label, mobileLibrary, Link, List, Page, Select, SplitApp, StandardListItem, Text, TextArea, oCore, Element, Icon, Item, Title, Device, BlockLayout, BlockLayoutCell, BlockLayoutRow, SimpleForm, layoutLibrary) {
		"use strict";
