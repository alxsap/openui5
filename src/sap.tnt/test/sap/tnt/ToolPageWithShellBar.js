...
var data = {
	navigation: [
		{
			...
			expanded: true,
			items: [
				{ title: 'Child Item 1', key: 'page1' },
				{ title: 'Child Item 2 (Disabled)', enabled: false },
				{ title: 'Child Item 3', key: 'page2' },
				{ title: 'Child Item 4', key: 'page3' }]
		},
		{
			title: 'Root Item',
			icon: 'sap-icon://bed',
	...
	fixedNavigation: [
		{ title: 'Fixed Item 1', icon: 'sap-icon://employee' },
		{ title: 'Fixed Item 2', icon: 'sap-icon://building' },
		{ title: 'Fixed Item 3', icon: 'sap-icon://card' }]
};
model.setData(data);

var oSideNavigation = new sap.tnt.SideNavigation("SNav", {
	expanded: false,
...
var oNavContainer = new sap.m.NavContainer({
	pages: [
		new sap.m.ScrollContainer('page1', {
			vertical: true,
			height: "100%",
			horizontal: false,
			content: [
		...
		new sap.m.ScrollContainer('page2', {
			vertical: true,
			height: "100%",
			horizontal: false,
			content: [
	...
	menu: new sap.m.Menu({
		...
		items: [
			new sap.m.MenuItem({
				...
				items: [
					new sap.m.MenuItem({ text: "accidental leave", icon: "sap-icon://accidental-leave" }),
					new sap.m.MenuItem({ text: "iphone", icon: "sap-icon://iphone" }),
					new sap.m.MenuItem({ text: "globe", icon: "sap-icon://globe" })
				]
			})
		]
	}),
