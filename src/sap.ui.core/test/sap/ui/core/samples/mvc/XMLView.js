sap.ui.define([
...
], function(Button, ViewType, CheckBox, jQuery) {
	"use strict";
	try{
	...
	new Button({text:"Create View",press:function(){
		var view = sap.ui.view({id:"myView",viewName:"sap.ui.core.mvctest.Test",type:ViewType.XML});
	...
	Object.defineProperty(globalThis, "view", {
		configurable: "false",
		writable: "true",
		value: sap.ui.view({id:"myView",viewName:"sap.ui.core.mvctest.Test",type:ViewType.XML})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oCheckBox", {
		configurable: "false",
		writable: "true",
