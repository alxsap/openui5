sap.ui.define(
	["sap/ui/core/Control", "sap/ui/model/odata/v2/ODataModel", "sap/ui/layout/VerticalLayout"],
	function(Control, ODataModel, VerticalLayout) {
		...
		Object.defineProperty(globalThis, "iResponseDelay", {
			configurable: "false",
			writable: "true",
			value: 200
		});
		...
		/* TODO: Consider replacing this
			* with a local var (let x=...) or 
			* with an AMD export/import (export.x=..., ...=X.x) */
		Object.defineProperty(globalThis, "iMaxAge", {
			configurable: "false",
			writable: "true",
			value: 30000
		});
		...
		/* TODO: Consider replacing this
			* with a local var (let x=...) or 
			* with an AMD export/import (export.x=..., ...=X.x) */
		Object.defineProperty(globalThis, "xhr", {
			configurable: "false",
			writable: "true",
			value: sinon.useFakeXMLHttpRequest()
		});
		...
		Object.defineProperty(globalThis, "oModel", {
			...
			value: new ODataModel("fakeservice://northwind", {
