sap.ui.define([
	...
	Object.defineProperty(globalThis, "ctrl", {
		configurable: "false",
		writable: "true",
		value: new Button({text:"Click me!",press:readDataOnPress})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oDataTemplate", {
		configurable: "false",
		writable: "true",
		value: new CustomData({key:"answer"})
	});
	...
	Object.defineProperty(globalThis, "xml", {
		...
		value: '<mvc:View xmlns:core="sap.ui.core" xmlns:mvc="sap.ui.core.mvc" xmlns="sap.ui.commons" controllerName="my.own.controller" '
