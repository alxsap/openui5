sap.ui.define([
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oCalendars", {
		configurable: "false",
		writable: "true",
		value: new JSONModel(CalendarType)
	});

	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormatYyyymmdd", {
		configurable: "false",
		writable: "true",
		value: DateFormat.getInstance({pattern: "yyyyMMdd", calendarType: CalendarType.Gregorian})
	});

	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "aSpecialDays", {
		configurable: "false",
		writable: "true",

		value: [["20160101",undefined,"Neujahr",1],
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oCal", {
		configurable: "false",
		writable: "true",

		value: new Calendar("Cal1",{
			legend: "Legend1",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oForm", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormContainer", {
		configurable: "false",
		writable: "true",
		value: new FormContainer("F1C1")
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormElement", {
		configurable: "false",
		writable: "true",

		value: new FormElement("F1E1", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oListBox", {
		configurable: "false",
		writable: "true",

		value: new ListBox("LB",{
			editable: false,
			visibleItems: 10,
			width: "8em"
		}).placeAt("event3")
	...
	Object.defineProperty(globalThis, "oBtn", {
		...
		value: new ToggleButton("button5",{
