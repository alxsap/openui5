sap.ui.define([
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormatYyyyMMddHHmmss", {
		configurable: "false",
		writable: "true",
		value: DateFormat.getInstance({pattern: "yyyyMMddHHmmss", calendarType: CalendarType.Gregorian})
	});
	...
	Object.defineProperty(globalThis, "aSpecialDays", {
		...
		value: [["20150101",undefined,"Neujahr",1],
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTimesRow", {
		configurable: "false",
		writable: "true",
	...
	Object.defineProperty(globalThis, "oLabel", {
		configurable: "false",
		writable: "true",
		value: new Label({text: "focused date", labelFor: "TF2"}).placeAt("event1")
	});
