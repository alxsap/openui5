sap.ui.define([
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormatYyyyMMddHHmm", {
		configurable: "false",
		writable: "true",
		value: DateFormat.getInstance({pattern: "yyyyMMddHHmm", calendarType: CalendarType.Gregorian})
	});

	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleSelect", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oRow1", {
		configurable: "false",
		writable: "true",

		value: new CalendarRow("Row1",  {
				select: handleSelect,
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oStartDate", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oEndDate", {
		configurable: "false",
		writable: "true",
		value: UI5Date.getInstance()
	});
	...
	Object.defineProperty(globalThis, "oApp", {
		...
		value: new CalendarAppointment("App1", {
	...
	Object.defineProperty(globalThis, "oLabel", {
		configurable: "false",
		writable: "true",
		value: new Label({text: "start date", labelFor: "TF1"}).placeAt("event1")
	});
	...
	Object.defineProperty(globalThis, "oLabel", {
		configurable: "false",
		writable: "true",
		value: new Label({text: "Interval type", labelFor: "RG1"}).placeAt("event1")
	});
	...
	Object.defineProperty(globalThis, "oLabel", {
		configurable: "false",
		writable: "true",
		value: new Label({text: "intervals", labelFor: "TF2"}).placeAt("event1")
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oExtraApp", {
		configurable: "false",
		writable: "true",

		value: new CalendarAppointment("ExtraApp", {
			startDate: oStartDate,
			endDate: oEndDate,
			type: CalendarDayType.Type10,
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oDropdownBox", {
		configurable: "false",
		writable: "true",

		value: new ComboBox("DB-Vis", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oRow2", {
		configurable: "false",
		writable: "true",

		value: new CalendarRow("Row2",  {
				select: handleSelect,
				width: "600px",
				height: "6rem",
				intervals: 6,
	...
	Object.defineProperty(globalThis, "oLegend", {
		...
		value: new CalendarLegend("Legend1", {
			items: [
