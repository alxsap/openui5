sap.ui.define([
	...
	Object.defineProperty(globalThis, "oTableData", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oColumnTemplate", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oListTemplate", {
		configurable: "false",
		writable: "true",
	...
	Object.defineProperty(globalThis, "oModel", {
		configurable: "false",
		writable: "true",
		value: new JSONModel(oTableData)
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oListfilter", {
		configurable: "false",
		writable: "true",
