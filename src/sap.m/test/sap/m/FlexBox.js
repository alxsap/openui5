var oButton1 = new sap.m.Button({
	...
	press: function(){
		var bIsVisible = sap.ui.getCore().byId("__image1-__clone1")/*Not inside AMD call*/.getVisible();
		bIsVisible = !bIsVisible;
		sap.ui.getCore().byId("__image1-__clone1")/*Not inside AMD call*/.setVisible(bIsVisible);
	}
});
...
var oFlexBox1 = new sap.m.FlexBox("flexbox1", {
	fitContainer: true,
	wrap: "Wrap",
...
var oLayout1 = new sap.ui.layout.VerticalLayout("layout", {
	content: [
				oButton1,
				oFlexBox1
			]
...
var oImage4 = new sap.m.Image({
	...
	decorative: false,
	densityAware: false,
	layoutData: new sap.m.FlexItemData({growFactor: 1, shrinkFactor: 1, baseSize: "0%"})
});
...
var oFlexBox2 = new sap.m.FlexBox("flexbox2", {
	renderType: "Div",
	width: "100%",
	items: [
		oImage4.clone(),
...
var oFlexBox3 = new sap.m.FlexBox("flexbox3", {
	renderType: "Bare",
	width: "100%",
	items: [
		oImage4.clone(),
...
var oFlexBox4 = new sap.m.FlexBox({
	renderType: "Bare",
	alignItems: "Center",
