sap.ui.define([
	...
	Object.defineProperty(globalThis, "oEventList", {
		configurable: "false",
		writable: "true",
		value: new List()
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "fEventWriter", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer0", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("editableTokenizerNarrow", {
			renderMode: "Narrow",
			width: "400px",
			tokens: [
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer01", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("readonlyTokenizerNarrow", {
			renderMode: "Narrow",
			editable: false,
			width: "400px",
			tokens: [
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer1", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("editableTokenizer", {
			tokens: [
				new Token({text: "Token 1", key: "0001"}),
				new Token({text: "Token 2", key: "0002"}),
				new Token({text: "Token 3", key: "0003"}),
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer2", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("notEditableTokenizer",{
			tokens: [
				new Token({text: "Token 1", key: "0001"}),
				new Token({text: "Token 2", key: "0002"}),
				new Token({text: "Token 3", key: "0003"}),
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer3", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("editableAndNotEditable",{
			tokens:[
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer4", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("setWidth",{
			tokens:[
				new Token({text:"Dente", editable: false}),
				new Token({text:"Friese", editable: false}),
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer5", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("editableAndReadonly",{
			width: "200px",
			tokens:[
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "toggleReadOnlyBtn", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer7", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("tokenizerLongToken", {
			width: "200px",
			tokens: [
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTokenizer8", {
		configurable: "false",
		writable: "true",

		value: new Tokenizer("tokenizerReadOnlyLongToken", {
			width: "200px",
			editable: false,
			tokens: [
