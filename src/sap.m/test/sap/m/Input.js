sap.ui.define([
	...
	Object.defineProperty(globalThis, "jsonModel", {
		configurable: "false",
		writable: "true",
		value: new JSONModel()
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestInput1", {
		configurable: "false",
		writable: "true",

		value: new Input("suginput1", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestionItemTemplate1", {
		configurable: "false",
		writable: "true",
		value: new ListItem({text: "{CompanyName}"})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestInput5", {
		configurable: "false",
		writable: "true",

		value: new Input("suginput5", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestionItemTemplate5", {
		configurable: "false",
		writable: "true",
		value: new ListItem({text: "{CompanyName}", additionalText: "{City}"})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "aData", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oLongValueStateInput", {
		configurable: "false",
		writable: "true",

		value: new Input("sugInp-longvaluestate", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestInput2", {
		configurable: "false",
		writable: "true",

		value: new Input("suginput2", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestInput6", {
		configurable: "false",
		writable: "true",

		value: new Input("suginput6", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "aAlreadyAddedUsers", {
		configurable: "false",
		writable: "true",
		value: []
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestInput3", {
		configurable: "false",
		writable: "true",

		value: new Input("suginput3", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oModel2", {
		configurable: "false",
		writable: "true",
		value: new JSONModel()
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestInput4", {
		configurable: "false",
		writable: "true",

		value: new Input("suginput4", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestionData", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oI18nModel", {
		configurable: "false",
		writable: "true",
		value: new JSONModel()
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTableItemTemplate", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput1", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput1", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestionRowTemplate", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput2", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput2", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "aAlreadyAddedProducts", {
		configurable: "false",
		writable: "true",
		value: []
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput3", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput3", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput4", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput4", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput5", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput5", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput6", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput6", {
			placeholder: "Tabular suggest with value help and overflow (starts with H) (500px width)",
			showValueHelp: true,
			showTableSuggestionValueHelp: false,
			width: "50%",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "aAlreadyAddedProducts7", {
		configurable: "false",
		writable: "true",
		value: []
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput7", {
		configurable: "false",
		writable: "true",

		value: new Input("sugtableinput7", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSuggestTableInput8", {
		configurable: "false",
		writable: "true",

		value: new Input("sugTableInput8", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSugggestTable8Btn", {
		configurable: "false",
		writable: "true",

		value: new Button("sugTable8Btn", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oValueStateInput1", {
		configurable: "false",
		writable: "true",

		value: new Input("vsinput1", {
			valueState: "Error",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oValueStateInput2", {
		configurable: "false",
		writable: "true",

		value: new Input("vsinput2", {
			valueState: "Warning",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormattedValueStateInput", {
		configurable: "false",
		writable: "true",

		value: new Input("fvsinput", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFormattedValueStateInput2", {
		configurable: "false",
		writable: "true",

		value: new Input("fvsinput2", {
			valueState: "Warning",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oValueStateInput3", {
		configurable: "false",
		writable: "true",

		value: new Input("vsinput3", {
			valueState: "Information",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oValueStateInput4", {
		configurable: "false",
		writable: "true",

		value: new Input("vsinput4", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "page3", {
		configurable: "false",
		writable: "true",

		value: new Page("page3",{
			title: "Input in List",
			footer: createFooter()
		})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "page4", {
		configurable: "false",
		writable: "true",

		value: new Page("page4",{
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "b4i", {
		configurable: "false",
		writable: "true",

		value: new Button({text: "Submit", press: function() {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "p4i1", {
		configurable: "false",
		writable: "true",
