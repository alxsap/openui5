...
sap.ui.define([
  ...
  var debugSelectedFilterItems = function (aItems) {
	  var sFilterString = "",
		  i = 0;
  ...
  var customPriceCallback = function (oControl) {
	  var aFilters = [],
  ...
  var customPriceReset = function (oEvent) {
	  var source = oEvent.getSource(),
  ...
  var customPriceCancel = customPriceReset;
  ...
  var presetFilters3 = new Filter("price", FilterOperator.GT, 50);
  ...
  var vsd1 = new ViewSettingsDialog("vsd1", {
  ...
  var vsd2 = new ViewSettingsDialog("vsd2", {
	  confirm: function (oEvent) {
		  var p = oEvent.getParameters(),
			  sSortPath = null,
			  oSorter,
  ...
  var vsd3 = new ViewSettingsDialog("vsd3", {
	  confirm: function (oEvent) {
		  var p = oEvent.getParameters();
  ...
  var vsd4 = new ViewSettingsDialog("vsd4", {
	  confirm: function (oEvent) {
		  var p = oEvent.getParameters(),
			  oSorter = null;
  ...
  var vsd5 = new ViewSettingsDialog("vsd5", {
  ...
  var vsd6 = new ViewSettingsDialog("vsd6", {
	  confirm: function (oEvent) {
		  var p = oEvent.getParameters(),
			  aFilters,
			  aTableFilters = [];
  ...
  var vsd7 = new ViewSettingsDialog("vsd7", {
	  confirm: function (oEvent) {
		  var p = oEvent.getParameters(),
			  aFilters,
			  oCallback,
