sap.ui.define([
	...
	Object.defineProperty(globalThis, "oDialog1", {
		configurable: "false",
		writable: "true"
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oPopover", {
		configurable: "false",
		writable: "true"
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "demoPage", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgDesert", {
		configurable: "false",
		writable: "true",

		value: new Image("desert", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgElephant", {
		configurable: "false",
		writable: "true",

		value: new Text("elephant", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgFishImg", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgForest", {
		configurable: "false",
		writable: "true",

		value: new Image("forest", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "scrollForest", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgHuntingLeopard", {
		configurable: "false",
		writable: "true",

		value: new Image("huntingLeopard", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgPrairie", {
		configurable: "false",
		writable: "true",

		value: new Image("prairie", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgWaterfall", {
		configurable: "false",
		writable: "true",

		value: new Image("waterfall", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgLeopard", {
		configurable: "false",
		writable: "true",

		value: new Image("leopard", {
			src: "images/demo/nature/huntingLeopard.jpg",
			alt: "Hunting Leopard, Full Speed",
			densityAware: false,
			decorative: false
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgWaterfall2", {
		configurable: "false",
		writable: "true",

		value: new Image("waterfall2", {
			src: "images/demo/nature/waterfall.jpg",
			alt: "Waterfall in the Jungle",
			densityAware: false,
			decorative: false
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgLeopard2", {
		configurable: "false",
		writable: "true",

		value: new Image("leopard2", {
			src: "images/demo/nature/huntingLeopard.jpg",
			alt: "Hunting Leopard, Full Speed",
			densityAware: false,
			decorative: false
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "imgWaterfall3", {
		configurable: "false",
		writable: "true",

		value: new Image("waterfall3", {
			src: "images/demo/nature/waterfall.jpg",
			alt: "Waterfall in the Jungle",
			densityAware: false,
			decorative: false
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "carousel", {
		configurable: "false",
		writable: "true",

		value: new Carousel("myCarousel", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "appCarousel", {
		configurable: "false",
		writable: "true",
		value: new App("myApp", {initialPage:"carouselPage"})
	});

	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "carouselPage", {
		configurable: "false",
		writable: "true",

		value: new Page("carouselPage",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSegmentedButton1", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oSegmentedButton2", {
		configurable: "false",
		writable: "true",
