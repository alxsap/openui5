sap.ui.require(["sap/ui/core/Core"], Core => Core.ready(function () {
	sap.ui.require([
		...
		"sap/ui/table/Table",
		"sap/ui/table/Column"
	], function(Theming, JSONModel, App, Button, Column, ColumnListItem, Label, List, MessageBox, MultiInput, Page, StandardListItem, Table, Text, Token, coreLibrary, GridTable, GridTableColumn) {
