sap.ui.define([
	...
	Object.defineProperty(globalThis, "StandardCalendarLegendItem", {
		configurable: "false",
		writable: "true",
		value: StandardCalendarLegendItem
	}), Object.defineProperty(globalThis, "UI5Date", {
		configurable: "false",
		writable: "true",
		value: sap.ui.require("sap/ui/core/date/UI5Date")
	}), Object.defineProperty(globalThis, "oLegend", {
		configurable: "false",
		writable: "true",

		value: new PlanningCalendarLegend("Legend1", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oDialog", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oEventLabel", {
		configurable: "false",
		writable: "true",
		value: new Label({text: "Events log"})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleIntervalSelect", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleAppointmentSelect", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleAddRow", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleAddAppointment", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleStartDateChange", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleRowSelectionChange", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleRowHeaderPress", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "handleLegend", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oMultiAppsSelectButton", {
		configurable: "false",
		writable: "true",

		value: new ToggleButton("MultiSelect", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonAddAppointment", {
		configurable: "false",
		writable: "true",

		value: new Button("B_AddAppointment", {
			icon: "sap-icon://add",
			type: ButtonType.Transparent,
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonAddRow", {
		configurable: "false",
		writable: "true",

		value: new Button("B_AddRow", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonShowIntervalHeaders", {
		configurable: "false",
		writable: "true",

		value: new ToggleButton("B_ShowIntHead", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonShowRowHeaders", {
		configurable: "false",
		writable: "true",

		value: new ToggleButton("B_ShowRowHead", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonShowWeekNumbers", {
		configurable: "false",
		writable: "true",

		value: new ToggleButton("B_ShowWeekNumbers", {
			type: ButtonType.Transparent,
			text: "Weeks",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonLegend", {
		configurable: "false",
		writable: "true",

		value: new Button("B_Legend", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonReducedHeight", {
		configurable: "false",
		writable: "true",

		value: new ToggleButton("B_ReducedHeight", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonToggleAlternatingRowColor", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonToggleSpecNoWork", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonToggleShowDayNamesLine", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonToggleCustomViews", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oDialog2", {
		configurable: "false",
		writable: "true"
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonMinMax", {
		configurable: "false",
		writable: "true",

		value: new Button("B_MinMax", {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oVisLabel", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oVisSelect", {
		configurable: "false",
		writable: "true",

		value: new Select("Sel-Vis", {
			layoutData: new OverflowToolbarLayoutData({
				group: 2
			}),
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oGroupModeLabel", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oGroupModeSelect", {
		configurable: "false",
		writable: "true",

		value: new Select("Sel-Group", {
			layoutData: new OverflowToolbarLayoutData({
				group: 3
			}),
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oTitle", {
		configurable: "false",
		writable: "true",

		value: new MTitle("Title1", {
			text: "Title"
		})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oButtonSwitchLegendAssociation", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oLegendLabel", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oOLI", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oPC1", {
		configurable: "false",
		writable: "true",

		value: new PlanningCalendar("PC1", {
