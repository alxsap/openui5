sap.ui.define([
	...
	Object.defineProperty(globalThis, "oFloat", {
		configurable: "false",
		writable: "true",
		value: NumberFormat.getFloatInstance({minFractionDigits: 2, maxFractionDigits: 2})
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label1", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label1Small", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label2", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label3", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label3a", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label4", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label4Small", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label7", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label9", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label10", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label11", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label11a", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label12", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label13", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label14", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "label15", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb1", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb1", {
			selectedKey: "key3",
			upperCase: true,
			items: [
				new IconTabFilter({
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb1Small", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb1Small", {
			selectedKey: "key3",
			upperCase: true,
			items: [
				new IconTabFilter({
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb2", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb2", {
			selectedKey: "key13",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "titleSelectorEventHandler", {
		configurable: "false",
		writable: "true",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb3", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb3", {
			selectedKey: "key13",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oh3a", {
		configurable: "false",
		writable: "true",

		value: new ObjectHeader("oh3a", {
			responsive: true,
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb3a", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb3a", {
			selectedKey: "key13",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb4", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb4", {
			selectedKey: "key13",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oh4Small", {
		configurable: "false",
		writable: "true",

		value: new ObjectHeader("oh4Small", {
			responsive: true,
			intro: "On behalf of John Smith Ñagçyfox",
			title: "An apple a day keeps the doctor away",
			icon: "sap-icon://nutrition-activity",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb4Small", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb4Small", {
			selectedKey: "key13",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb7", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb7", {
			selectedKey: "key3",
			items: [
				new IconTabFilter({
					count: "32",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb11", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb11", {
			selectedKey: "key1",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oh11a", {
		configurable: "false",
		writable: "true",

		value: new ObjectHeader("oh11a", {
			responsive: true,
			intro: "On behalf of John Smith Ñagçyfox",
			title: "This is a title",
			attributes: [
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb11a", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb11a", {
			selectedKey: "key1",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb12", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb12", {
			selectedKey: "key1",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "itb13", {
		configurable: "false",
		writable: "true",

		value: new IconTabBar("itb13", {
			selectedKey: "key1",
			items: [
				new IconTabFilter({
					icon: "sap-icon://hint",
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "ohEmptyAttribute", {
		configurable: "false",
		writable: "true",

		value: new ObjectHeader("ohEA", {
			responsive: true,
