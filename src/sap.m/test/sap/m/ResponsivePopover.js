...
var oBeginButton = new sap.m.Button("actionButton1",{
	text: "Action1",
...
var footer = new sap.m.Bar({
	contentLeft: [],
	contentMiddle: [
		new sap.m.Button({icon: "sap-icon://globe", tooltip: "Global Action 1"}),
