sap.ui.define([
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oGenderSorter", {
		configurable: "false",
		writable: "true",
		value: new Sorter("gender", false, true)
	});
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oLastNameSorter", {
		configurable: "false",
		writable: "true",

		value: new Sorter("lastName", false, function(oContext){
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oFirstNameSorter", {
		configurable: "false",
		writable: "true",

		value: new Sorter("firstName", false, function(oContext){
			return {
	...
	/* TODO: Consider replacing this
		* with a local var (let x=...) or 
		* with an AMD export/import (export.x=..., ...=X.x) */
	Object.defineProperty(globalThis, "oDateSorter", {
		configurable: "false",
		writable: "true",

		value: new Sorter("birthDate", false, function(oContext){
